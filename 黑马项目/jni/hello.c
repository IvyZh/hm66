...
void Java_com_ivy_hm66_activity_JNIActivity_cCallJavaSum(JNIEnv* env,jobject thiz){
	//打印日志
	jclass clazz = (*env)->FindClass(env,"com/ivy/hm66/activity/JNIActivity");

//	jmethodID   (*GetMethodID)(JNIEnv*, jclass, const char*, const char*);
	jmethodID methodId = (*env)->GetMethodID(env,clazz,"addTwoNum","(II)V");

	//void       (*CallVoidMethod)(JNIEnv*, jobject, jmethodID, ...);
	(*env)->CallVoidMethod(env,thiz,methodId,2,8);
